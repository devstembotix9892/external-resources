...
module.exports = {
    'en': {
        ...
        'QDPRobotC02.name': 'QDPRobotC02',
        'apds9960.description': 'Proximity, Light, RGB, and Gesture Sensor which uses an I2C interface.',
        'apds9960.name': 'APDS9960',
        'bleRobot.description': 'Control AI Robotic RC Car via Bluetooth with dynamic keys, attachments, and sensors.',
        'bleRobot.name': 'AI Robotic RC Car',
        'currentsensor.description': 'Measure AC/DC current using ACS712 Hall-effect current sensor module.',
        'currentsensor.name': 'Current Sensor',
        ...
        'intermediateKit.description': 'AI and Robotics kit based on ESP32.',
        'iotAiKit.description': 'AI and IoT kit based on Arduino Nano.',
        'iotAiKitnew.description': 'Updated AI and IoT kit based on Arduino Nano.',
        'irRemoteReceiver.description': 'Receiving and decoding data in infrared carrier.',
        'irRemoteReceiver.name': 'IR Remote Receiver',
        'laser.description': 'Control V1_Laser (S/V/G): ON/OFF, blink, SOS, PWM, fade, and status blocks for AI&Robotics / AI&IoT kits.',
        'laser.name': 'Laser',
        'ironKit.description': 'Yiqichuang iron kit robot.',
        'ironKit.name': 'Iron Kit',
        ...
        'reedswitch.description': 'Detect magnetic field using Reed Switch sensor - read digital ON/OFF state.',
        'reedswitch.name': 'Reed Switch',
        'rotaryencoder.description': 'Read rotation direction, count steps and button press from Rotary Encoder.',
        'rotaryencoder.name': 'Rotary Encoder',
        'tiltsensor.description': 'Detect tilt using a digital tilt switch (pull-up, LOW = tilt).',
        'tiltsensor.name': 'Tilt Sensor',
        'touchsensor.description': 'Read digital touch sensor ON/OFF state (e.g., TTP223).',
        'touchsensor.name': 'Touch Sensor',
        'vibrationmotor.description': 'Drive a vibration (haptic) motor module (S / V / G) with ON/OFF, PWM power, or timed pulse.',
        'vibrationmotor.name': 'Vibration Motor',
        'voltagesensor.description': 'Read analog voltage (divider output) and convert to volts.',
        'voltagesensor.name': 'Voltage Sensor',
        'waterpump.description': 'Control V1_Water Pump module (S/V/G) with ON/OFF on a digital pin. Pin list follows AI&Robotics / AI&IoT board flyout.',
    ...
    'zh-cn': {
        ...
        'QDPRobotC02.name': '齐护机器人 C02',
        'apds9960.description': '使用 I2C 接口的接近、灯光、RGB和手势传感器。',
        'apds9960.name': 'APDS9960',
        'bleRobot.description': '通过蓝牙动态按键、附件和传感器控制 AI 遥控赛车。',
        'bleRobot.name': 'AI 遥控赛车',
        'currentsensor.description': '使用 ACS712 霍尔效应电流传感器模块测量交流/直流电流。',
        'currentsensor.name': '电流传感器',
        ...
        'intermediateKit.description': '基于 ESP32 的 AI 与机器人套件。',
        'iotAiKit.description': '基于 Arduino Nano 的 AI 与物联网套件。',
        'iotAiKitnew.description': '基于 Arduino Nano 的 AI 与物联网套件（新版）。',
        'irRemoteReceiver.description': '接收并解码红外载波中的数据。',
        'irRemoteReceiver.name': '红外遥控接收器',
        'laser.description': '控制 V1_Laser（S/V/G）：开关、闪烁、SOS、PWM、渐变及状态积木，适用于 AI&Robotics / AI&IoT 套件。',
        'laser.name': '激光',
        ...
        'reedswitch.description': '使用干簧管开关检测磁场 — 读取数字开关状态。',
        'reedswitch.name': '干簧管开关',
        'rotaryencoder.description': '读取旋转编码器的旋转方向、步数和按钮按压。',
        'rotaryencoder.name': '旋转编码器',
        'tiltsensor.description': '使用数字倾斜开关检测倾斜（上拉，LOW = 倾斜）。',
        'tiltsensor.name': '倾斜传感器',
        'touchsensor.description': '读取数字触摸传感器的开关状态（如 TTP223）。',
        'touchsensor.name': '触摸传感器',
        'vibrationmotor.description': '驱动振动（触觉）马达模块（S/V/G），支持开关、PWM 功率或定时脉冲。',
        'vibrationmotor.name': '振动马达',
        'voltagesensor.description': '读取模拟电压（分压输出）并转换为伏特值。',
        'voltagesensor.name': '电压传感器',
        'waterpump.description': '通过数字引脚控制 V1 水泵模块（S/V/G）的开关。引脚列表遵循 AI&Robotics / AI&IoT 开发板菜单。',
        'waterpump.name': '水泵'
    }
};